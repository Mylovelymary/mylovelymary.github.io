...
// Хагси — талисман Аптечки (версия 1, «пухлик»). Оригинальный SVG.
// Позы: calm (покачивается), wave (машет крылом), still (только моргает —
// дыханием управляет упражнение), breathe (дышит сам), cheer (радуется).
// Временный: ждём фирменного Хагси от дизайнера, тогда заменим этот файл.
